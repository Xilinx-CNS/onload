...
void doPerformanceTrackerPipeline() {
  props.performanceTrackerProperties()

  autosmoke.doPerformanceTracker(vcm.sourceUrl(), vcm.branchName())
}

doPerformanceTrackerPipeline()
