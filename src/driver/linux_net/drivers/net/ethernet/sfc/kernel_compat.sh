...
EFX_NEED_SET_GSO_MAX_SIZE		nsymbol netif_set_gso_max_size	include/linux/netdevice.h
EFX_NEED_SET_GSO_MAX_SEGS		nsymbol netif_set_gso_max_segs	include/linux/netdevice.h
