 ...
 * EV_DATA[0:31] set to the value written, EV_DATA[32:59] = 0 and
 * EV_CODE = EV_CODE_USR_EV.  The PF driver may direct or disable
 * delivery of these events by setting %FR_CZ_USR_EV_CFG.
 *
