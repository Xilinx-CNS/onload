             ...
             efch_resource_t* rs, int intf_ver_id)
{
  ...
  int shm_ix;
  int qid = alloc->in_flags & EFCH_EFCT_RXQ_FLAG_NEW ? -1 : alloc->in_out_qid;
  int rc;
