 ...
 * the NVME_LOCAL_CRC_MODE feature. This mode does CRC "offload" in software
 * to allow testing without a plugin. */
#include <ci/internal/transport_config_opt_cloud.h>

#undef ONLOAD_BUILD_PROFILE
#define ONLOAD_BUILD_PROFILE "localcrc"

#undef NVME_LOCAL_CRC_MODE
#define NVME_LOCAL_CRC_MODE 1
