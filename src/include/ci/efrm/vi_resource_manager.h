...
struct efrm_vi {
	...
	/*! EFHW_VI_* flags */
	unsigned efhw_vi_flags;

	unsigned efrm_vi_flags;
#define EFRM_VI_RELEASED 0x00000001
#define EFRM_VI_OWNS_STACK_ID 0x00000002
#define EFRM_VI_STOPPING 0x00000004
