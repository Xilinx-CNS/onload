...
extern void ef10_ef100_mcdi_cmd_event_queue_disable(struct efhw_nic *nic, uint evq);

extern void ef10_ef100_mcdi_cmd_driver_event(struct efhw_nic *nic, uint64_t data,
					     uint32_t evq);

extern int ef10_ef100_mcdi_cmd_init_txq(struct efhw_nic *nic, dma_addr_t *dma_addrs,
...
extern int ef10_ef100_mcdi_cmd_init_rxq(struct efhw_nic *nic, dma_addr_t *dma_addrs,
					int n_dma_addrs, uint32_t port_id, uint8_t stack_id,
					uint32_t owner_id,
...
extern int ef10_ef100_flush_tx_dma_channel(struct efhw_nic *nic, uint dmaq);
