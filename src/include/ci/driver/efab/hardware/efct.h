...
#define EFCT_FLUSH_REASON_LBN 10
#define EFCT_FLUSH_REASON_WIDTH 6
#define EFCT_FLUSH_REASON_MCDI 0
#define EFCT_FLUSH_REASON_RX_BAD_DISC 1
#define EFCT_FLUSH_REASON_RX_FIFO_OVERFLOW 2
#define EFCT_FLUSH_REASON_RX_BAD_BUF_ADDR 3
#define EFCT_FLUSH_REASON_CTPIO_LEN 4
#define EFCT_FLUSH_REASON_CTPIO_ALIGN 5
#define EFCT_FLUSH_REASON_CTPIO_FIFO_OVERFLOW 6
#define EFCT_FLUSH_REASON_CTPIO_BAD_REORDERING 7
#define EFCT_FLUSH_REASON_CTPIO_BAD_TPL_FLAGS 8
#define EFCT_FLUSH_REASON_HW_INTERNAL 9
