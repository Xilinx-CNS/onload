...
struct xsn_storage_tx_create_app {
  uint16_t vi_id;
} __attribute__((aligned(4)));

#define XSN_STORAGE_TX_READ_DEBUG 0
#define XSN_STORAGE_TX_CREATE_APP 1
