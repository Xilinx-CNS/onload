...
# kbuild can figure this out automatically, ubuild (currently) can't:
$(objd)$(MMAKE_OBJ_PREFIX)vi_init.o: ../../include/onload_version.h
endif
...
clean:
	@$(MakeClean)
	rm -f ci_ul_lib.o efch_intf_ver.h
endif
