...
#define STRUCT_NETIF_STATE_NIC(ctx)                                     \
  ...
  FTL_TFIELD_CONSTINT(ctx, ci_uint16, vi_evq_reserved_slots, ORM_OUTPUT_STACK) \
  ...
  FTL_TFIELD_CONSTINT(ctx, ci_uint16, vi_channel_or_irq, ORM_OUTPUT_STACK) \
...
#define STRUCT_TCP_LISTEN(ctx) \
    ...
    ON_CI_CFG_FD_CACHING(                                                     \
      ...
      FTL_TFIELD_STRUCT(ctx, oo_p_dllink_t,            \
